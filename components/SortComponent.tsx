...
import { Card, Divider, List, Modal, Portal, useTheme } from "react-native-paper";
...
function SortComponent<T>({
    ...
    return (
        <Portal>
            ...
            >
                <Card>
                    <Card.Title title={title ?? t('sort.title', { defaultValue: 'Ordenar por' })} titleStyle={styles.modalTitle}/>
